      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2 grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          >
            ...
            <p className="text-gray-600 leading-relaxed">
              Localización y monitoreo en tiempo real a través de tecnología
              satelital GPS la ubicación de sus activos móviles.
            </p>
          </motion.div>
          ...
          >
            ...
            <p className="text-gray-600 leading-relaxed">
              Control total de flotas en un solo lugar.
            </p>
          </motion.div>

          {/* Safe and reliable */}
          <motion.div
            className="bg-gray-100 rounded-2xl p-8 md:col-span-2"
            initial={{ x: -100, opacity: 0 }}
            whileInView={{ x: 0, opacity: 1 }}
          ...
          >
            ...
            <p className="text-gray-600 leading-relaxed">
              Accede a historiales detallados de rutas, recibir alertas
              personalizadas, detectar robos, decenas de reportes y mucho más.
            </p>
          </motion.div>
        </div>
        ...
        >
          ...
          <h3 className="text-xl font-bold text-gray-900 mb-4">
            Preparados para cualquier vehículo
          </h3>
